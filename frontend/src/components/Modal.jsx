...
const Modal = ({ isOpen, onClose, data, onSave, isNew }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center">
            <div className="bg-white text-black p-6 rounded-xl w-[95%] max-w-md shadow-2xl transform transition-transform duration-300 scale-100 opacity-100 animate-[fadeIn_0.3s_ease-out]">
