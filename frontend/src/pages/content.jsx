            ...
            <div className="h-screen flex flex-col items-center">
                <div className="h-full flex w-5/10 flex-col">
                    ...
                    <div className="flex gap-3">
                        <div className="bg-[url('../assets/teclado.jpeg')] bg-cover bg-no-repeat bg-center w-5/10 h-96 rounded-lg flex justify-center items-center pl-3">
                            <div className="p-4 bg-[#13335b] rounded-l-lg">
                                <h2 className="text-xl text-amber-200">Empresa 1</h2>
                                <p>
